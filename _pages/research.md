...
To increase the angular sensitivity of each DSPD, we limit their field of view using a material which doubles as a calorimeter, thus allowing for complete energy reconstruction.
